...
const PortfolioBuy = ({ open, setVisibilityState, coin }: { open: boolean, setVisibilityState: React.Dispatch<React.SetStateAction<IDialogs>>, coin: string }) => {
    ...
    const handleDialogClose = () => {
        setVisibilityState({ portfolioBuyDialogVisibility: false });
    };
    return (
            ...
            <div className="portfolio-dialog">
                <div className="portfolio-dialog-content">
                    <div className="portfolio-dialog-header">
                        ...
                        <div className="title">Buy <span>{coin}</span></div>
                    </div>
