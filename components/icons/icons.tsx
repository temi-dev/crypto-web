...
const CopyIcon = ({ color }: { color?: string }) => {
    return (
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M23.3336 10.501H12.8336C11.5449 10.501 10.5002 11.5456 10.5002 12.8343V23.3343C10.5002 24.623 11.5449 25.6676 12.8336 25.6676H23.3336C24.6222 25.6676 25.6669 24.623 25.6669 23.3343V12.8343C25.6669 11.5456 24.6222 10.501 23.3336 10.501Z" stroke={color ? color : altColor} strokeWidth="2.33333" strokeLinecap="round" strokeLinejoin="round" />
...
const WalletAddressIcon = ({ color }: { color?: string }) => {
    return (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M4.16634 12.5C3.31634 12.5 2.53301 12.825 1.94134 13.3583C1.80801 13.475 1.68301 13.6 1.57467 13.7417C1.10801 14.3167 0.833008 15.0417 0.833008 15.8333C0.833008 17.675 2.33301 19.1667 4.16634 19.1667C4.96634 19.1667 5.69134 18.8833 6.26634 18.425C6.73301 18.0333 7.09967 17.525 7.29967 16.9417C7.43301 16.6 7.49967 16.225 7.49967 15.8333C7.49967 14 6.00801 12.5 4.16634 12.5ZM6.16634 15.1917C6.16634 15.425 5.98301 15.6 5.75801 15.6C5.53301 15.6 5.34967 15.425 5.34967 15.1917V15.1083C5.34967 15.0167 5.28301 14.9417 5.19134 14.9417H3.52467C3.60801 15.1 3.59134 15.2917 3.45801 15.425C3.38301 15.5 3.28301 15.5417 3.16634 15.5417C3.06634 15.5417 2.95801 15.5 2.88301 15.425L2.28301 14.825C2.24967 14.7917 2.21634 14.7417 2.19134 14.6917C2.15801 14.5917 2.15801 14.4833 2.19134 14.3833C2.21634 14.3417 2.24134 14.2833 2.28301 14.25L2.88301 13.6583C3.04134 13.4917 3.29967 13.4917 3.44967 13.6583C3.58301 13.7833 3.59967 13.9833 3.51634 14.1333H5.19134C5.72467 14.1333 6.15801 14.5667 6.15801 15.1083V15.1917H6.16634ZM5.16634 18.1333C5.05801 18.1333 4.94967 18.1 4.87467 18.0167C4.74134 17.8917 4.72467 17.6917 4.80801 17.5417H3.13301C2.59967 17.5417 2.16634 17.1083 2.16634 16.5667V16.4833C2.16634 16.25 2.34967 16.075 2.57467 16.075C2.79967 16.075 2.98301 16.25 2.98301 16.4833V16.5667C2.98301 16.6583 3.04967 16.7333 3.14134 16.7333H4.81634C4.73301 16.575 4.74967 16.3833 4.88301 16.25C5.04134 16.0917 5.29967 16.0917 5.44967 16.25L6.04967 16.85C6.08301 16.8833 6.11634 16.9333 6.14134 16.9833C6.17467 17.0833 6.17467 17.1917 6.14134 17.2917C6.11634 17.3333 6.08301 17.3833 6.04967 17.4167L5.44967 18.0083C5.37467 18.0917 5.26634 18.1333 5.16634 18.1333Z" fill={color ? color : altColor} />
            <path d="M12.3747 3.29183V6.4585H11.1247V3.29183C11.1247 3.06683 10.9247 2.9585 10.7913 2.9585C10.7497 2.9585 10.708 2.96683 10.6663 2.9835L4.05801 5.47516C3.61634 5.64183 3.33301 6.0585 3.33301 6.5335V7.09183C2.57467 7.6585 2.08301 8.56683 2.08301 9.59183V6.5335C2.08301 5.54183 2.69134 4.6585 3.61634 4.3085L10.233 1.8085C10.4163 1.74183 10.608 1.7085 10.7913 1.7085C11.6247 1.7085 12.3747 2.3835 12.3747 3.29183Z" fill={color ? color : altColor} />
            <path d="M17.9169 12.0832V12.9165C17.9169 13.1415 17.7419 13.3248 17.5086 13.3332H16.2919C15.8502 13.3332 15.4502 13.0082 15.4169 12.5748C15.3919 12.3165 15.4919 12.0748 15.6586 11.9082C15.8086 11.7498 16.0169 11.6665 16.2419 11.6665H17.5002C17.7419 11.6748 17.9169 11.8582 17.9169 12.0832Z" fill={color ? color : altColor} />
            <path d="M16.233 10.7918H17.083C17.5413 10.7918 17.9163 10.4168 17.9163 9.9585V9.59183C17.9163 7.86683 16.508 6.4585 14.783 6.4585H5.21634C4.50801 6.4585 3.85801 6.69183 3.33301 7.09183C2.57467 7.6585 2.08301 8.56683 2.08301 9.59183V11.0752C2.08301 11.3918 2.41634 11.5918 2.71634 11.4918C3.18301 11.3335 3.67467 11.2502 4.16634 11.2502C6.69134 11.2502 8.74967 13.3085 8.74967 15.8335C8.74967 16.4335 8.59134 17.0918 8.34134 17.6752C8.20801 17.9752 8.41634 18.3335 8.74134 18.3335H14.783C16.508 18.3335 17.9163 16.9252 17.9163 15.2002V15.0418C17.9163 14.5835 17.5413 14.2085 17.083 14.2085H16.358C15.558 14.2085 14.7913 13.7168 14.583 12.9418C14.4163 12.3085 14.6163 11.6918 15.033 11.2918C15.3413 10.9752 15.7663 10.7918 16.233 10.7918ZM11.6663 10.6252H7.49967C7.15801 10.6252 6.87467 10.3418 6.87467 10.0002C6.87467 9.6585 7.15801 9.37516 7.49967 9.37516H11.6663C12.008 9.37516 12.2913 9.6585 12.2913 10.0002C12.2913 10.3418 12.008 10.6252 11.6663 10.6252Z" fill={color ? color : altColor} />
        </svg>
    )
}
...
const GiftBoxIllustration = () => {
    return (
        <svg width="39" height="40" viewBox="0 0 39 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_1562_27830)">
                <path d="M19.3518 39.149C30.0158 39.149 38.6607 30.5041 38.6607 19.8401C38.6607 9.17613 30.0158 0.53125 19.3518 0.53125C8.68784 0.53125 0.0429688 9.17613 0.0429688 19.8401C0.0429688 30.5041 8.68784 39.149 19.3518 39.149Z" fill="#DEE2FB" />
                <path d="M17.6376 23.8562L17.7727 17.4549C16.6091 17.2211 14.3209 16.5707 13.1321 14.9749C12.8116 14.544 12.5863 14.0522 12.4707 13.5311C12.3551 13.0099 12.3517 12.4708 12.4607 11.9483C12.8601 9.87124 14.368 9.27402 15.5469 9.38522C16.9639 9.53102 18.4624 10.651 19.3539 12.3378C20.3606 10.8187 21.8595 9.4226 23.8508 9.94445C24.5394 10.1041 25.1448 10.505 25.5532 11.0717C25.9616 11.6384 26.1448 12.3318 26.0683 13.0217C25.9074 15.1922 23.6467 17.73 19.7847 18.1556L19.7074 17.4633L17.6376 23.8562ZM23.0175 12.212C22.0113 12.281 20.8896 14.2587 20.3253 15.7043C22.5201 15.2128 23.6411 13.7839 23.7194 12.8653C23.7379 12.7946 23.7407 12.7208 23.7277 12.6489C23.7147 12.577 23.6862 12.5086 23.6441 12.4484C23.6019 12.3882 23.5472 12.3376 23.4834 12.2998C23.4197 12.2621 23.3484 12.2381 23.2745 12.2296C23.1903 12.2101 23.1035 12.2041 23.0175 12.212ZM15.2149 11.7359C15.0917 11.7444 14.9185 11.8386 14.814 12.3905C14.7638 12.5978 14.7602 12.8134 14.8034 13.0222C14.8466 13.2311 14.9355 13.4282 15.0641 13.6C15.6168 14.3459 16.8249 14.8117 17.7652 15.053C17.4989 13.1117 16.112 11.8194 15.299 11.738L15.2149 11.7359Z" fill="white" />
                <path d="M28.0697 17.944L10.4099 17.8594L10.3469 30.5066L28.0066 30.5913L28.0697 17.944Z" fill="#1D38E4" />
                <path d="M28.7873 16.3794L9.93164 16.2891L9.91619 19.3893L28.7718 19.4797L28.7873 16.3794Z" fill="#1D38E4" />
                <g opacity="0.29">
                    <path d="M28.7865 16.3775L9.93091 16.2871L9.91546 19.3874L28.7711 19.4777L28.7865 16.3775Z" fill="#FFCD8E" />
                </g>
                <path d="M20.5945 15.6467L17.7043 15.6328L17.6276 31.0285L20.5178 31.0423L20.5945 15.6467Z" fill="white" />
            </g>
            <defs>
                <clipPath id="clip0_1562_27830">
                    <rect width="38.6177" height="38.6177" fill="white" transform="translate(0.0429688 0.53125)" />
                </clipPath>
            </defs>
        </svg>
    )
...
const ChevronRightIcon = ({ color }: { color?: string }) => {
    return (
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_1562_27827)">
                <path d="M8.79199 5.57422L14.058 10.8403L8.79199 16.1063" stroke={color ? color : altColor} strokeWidth="1.75535" strokeLinecap="round" strokeLinejoin="round" />
            </g>
            <defs>
                <clipPath id="clip0_1562_27827">
                    <rect width="21.0642" height="21.0642" fill={color ? color : altColor} transform="translate(0.893066 0.308594)" />
                </clipPath>
            </defs>
        </svg>
    )
...
const UserFilledIcon = ({ color, fillColor }: { color?: string, fillColor: string }) => {
    return (
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="48" height="48" rx="24" fill={fillColor} />
            <path fillRule="evenodd" clipRule="evenodd" d="M23.8445 33.6613C20.1527 33.6613 17 33.0868 17 30.7861C17 28.4853 20.1327 26.3613 23.8445 26.3613C27.5364 26.3613 30.6891 28.4647 30.6891 30.7655C30.6891 33.0653 27.5564 33.6613 23.8445 33.6613Z" stroke={color ? color : altColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path fillRule="evenodd" clipRule="evenodd" d="M23.8372 23.174C26.26 23.174 28.2236 21.2104 28.2236 18.7877C28.2236 16.3649 26.26 14.4004 23.8372 14.4004C21.4145 14.4004 19.45 16.3649 19.45 18.7877C19.4418 21.2022 21.3918 23.1658 23.8063 23.174C23.8172 23.174 23.8272 23.174 23.8372 23.174Z" stroke={color ? color : altColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}

const GuardFilledIcon = ({ color, fillColor }: { color?: string, fillColor: string }) => {
    return (
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="48" height="48" rx="24" fill={fillColor} />
            <path d="M24.0001 15C26.3359 17.0666 29.3846 18.1426 32.5001 18C32.9537 19.543 33.0925 21.1615 32.9082 22.7592C32.7239 24.3569 32.2204 25.9013 31.4275 27.3005C30.6346 28.6998 29.5685 29.9254 28.2925 30.9045C27.0166 31.8836 25.5569 32.5962 24.0001 33C22.4433 32.5962 20.9836 31.8836 19.7076 30.9045C18.4317 29.9254 17.3656 28.6998 16.5727 27.3005C15.7798 25.9013 15.2762 24.3569 15.092 22.7592C14.9077 21.1615 15.0465 19.543 15.5001 18C18.6156 18.1426 21.6642 17.0666 24.0001 15" stroke={color ? color : altColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}
